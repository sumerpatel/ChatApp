package com.example.sumerpatel.chatapp.service;
...
/**
 * Created by sumerpatel on 3/24/2017.
 */
...
public class LocManager extends Service implements LocationListener {
    ...
    public LocManager(Context context, Activity activity) {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(activity, PermissionsLocation, REQUEST_CODE_PERMISSION);
                    }
